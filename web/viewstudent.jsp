...
<body>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="viewallstudent.jsp">
                        <input type="button" value="View All Students Data"/>
                    </a>
                </td>
            </tr>
        </table>
    ...
    <table>
        <%
            ...
            AdminDTO dto = f1.getStudentDetail(sid);
            if (dto == null) {
        %>
                <tr>
                    <td colspan="5" class="no-records">No Records Found for <%= sid %></td>
                </tr>
        <%
            } else {   
        %>
